...
class Columns extends Step
{
    ...
    public function __construct($plugin = \false)
    {
        ...
        $this->set_id('columns');
        $this->set_name(\__('Columns'));
        $this->set_title(\__('Table columns'));
        $this->set_description(\__('Next, choose which columns to display in the table.'));
    ...
    {
        $fields = [['type' => 'columns', 'label' => \__('Columns'), 'name' => 'columns', 'value' => '']];
        return $fields;
    }
    /**
     * {@inheritdoc}
