...
class Util
{
    ...
    public static function get_registered_post_types()
    {
        ...
        $unsupported_pts = ['acf-field', 'acf-field-group', 'nf_sub', 'edd_log', 'edd_payment', 'edd_discount', 'product_variation', 'shop_order_refund', 'tribe-ea-record', 'deleted_event', 'user_request', 'wp_template', 'wp_template_part', 'wp_global_styles', 'wp_navigation', 'shop_order', 'shop_coupon', 'shop_order_placehold', 'ept_post_type'];
    ...
    {
        return \get_terms(['taxonomy' => $taxonomy, 'hide_empty' => \false, 'fields' => 'id=>name', 'include' => $ids]);
    }
    /**
    ...
    public static function get_formatted_custom_fields($fields)
    {
        ...
        foreach ($fields as $field) {
            $formatted[] = \str_replace('cf:', '', $field);
        }
        return $formatted;
    }
    /**
