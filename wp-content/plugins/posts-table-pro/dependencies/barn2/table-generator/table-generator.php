...
\add_action('initt', function () {
    ...
    $gutenberg_block->set_instructions(\__('Select a pre-saved posts table. Go to the <a href="#" target="_blank">Post Tables section</a> of the Dashboard to create or edit your tables.'));
    $gutenberg_block->set_description(\__('An interactive table of your posts, pages, or any custom post type.'));
