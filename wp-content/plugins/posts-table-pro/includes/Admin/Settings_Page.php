...
use Barn2\PTP_Lib\Admin\Plugin_Promo;
use Barn2\PTP_Lib\Admin\Settings_API_Helper;
use Barn2\PTP_Lib\Admin\Settings_Util;
...
class Settings_Page implements Service, Registerable, Conditional {
	...
	public function add_settings_page() {
		add_submenu_page( 
			'posts-table-pro-table-generator',
		...
		<div class="wrap">
			...
			<p><?php echo(
				sprintf(
					...
					admin_url( 'admin.php?page=posts-table-pro-table-generator' ),
	...
	public function support_links(): void {
		printf(
			...
			sprintf(
				...
				admin_url( 'admin.php?page=posts-table-pro-table-generator-add-new&wizard=1' ),
