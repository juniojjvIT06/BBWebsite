...
class Table_Hooks extends WP_Scoped_Hooks implements Registerable {
	...
	public function register() {
		...
		$this->add_filter( 'posts_table_data_excerpt', [ $this, 'set_custom_video_playlist_class' ] );
		$this->add_filter( 'posts_table_data_content', [ $this, 'set_custom_video_playlist_class' ] );
		$this->add_filter( 'posts_table_data_custom_field', [ $this, 'set_custom_video_playlist_class' ] );
